...
// Parses the RA or DEC from a string that has an optional sign, a two digit degree, a seperator, a two digit minute, a
// seperator and a two digit second. Does not correct for hemisphere (derived class Declination takes care of that) For
// example:   -45*32:11 or 23:44:22
DayTime DayTime::ParseFromMeade(String const &s)
{
    ...
    // Check whether we have a sign. This should be able to parse RA and DEC strings (RA never has a sign, and DEC
