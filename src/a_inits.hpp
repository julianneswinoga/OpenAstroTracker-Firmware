...
// TODO: we have to change driver type to DRIVER_TYPE_TMC2209 and add a new definition for the actual mode (e.g.
// DRIVER_MODE_UART)
...
// AZ Motor pins
    ...
    // AZ Pins are defined based on driver type rather than stepper type since the 28BYJ may be used with a TMC2209 or
    // similar driver when modified to bipolar mode
