...
// Set the stepper motor parameters
    ...
    mount.configureDECStepper(
        DECmotorPin1, DECmotorPin2, DECmotorPin3, DECmotorPin4, RA_STEPPER_SPEED, DEC_STEPPER_ACCELERATION);
...
#else
    // 2 kHz updates (higher frequency interferes with serial communications and complete messes up OATControl
    // communications)
